...
const menuItems = [
  ...
  { text: 'Consumers', icon: <People />, path: '/consumers' },
  { text: 'Cylinder Bookings', icon: <CylinderIcon />, path: '/cylinder-bookings' },
  { text: 'Regulatory Ops', icon: <RegulatoryIcon />, path: '/regulatory' },
  { text: 'Reports', icon: <Assessment />, path: '/reports' },
  { text: 'Tariff Management', icon: <ReceiptLong />, path: '/tariff' },
